---
title: "Saying 'Hello world 💙' on `marbec-gpu`"
author: 
  - name: Auguste Verdier
    email: auguste.verdier@umontpellier.fr
description: |
  Un guide rapide sur la façon d'imprimer un `Hello world <3` sur `marbec-gpu`. | A quick guide on how to print a `Hello world <3` on `marbec-gpu`.
date: 2025-02-13
image: banner.jpg
about: 
  template: marquee
...
draft: false
engine: knitr
tags: ["marbec-data", "marbec-gpu", "Python", "R", "terminal", "bash", "hello world"]
categories: ["marbec-data", "marbec-gpu", "guides"]
---

Image credits: David Clode at [Unplash](https://unsplash.com/photos/black-snake-closeup-photo-QZePScKPb2Q?utm_content=creditShareLink&utm_medium=referral&utm_source=unsplash)

# [FR] Exécuter un exemple simple sur Marbec-GPU
...
![Créer un dossier de travail](images/create_folder.jpg)
...
![final_screen](images/final_screen.jpg)
...
# [EN] Running a simple example on Marbec-GPU
...
![Create a working directory](images/create_folder.jpg)
