...
La méthode la plus simple est d'utiliser la commande `cp` et les commandes de navigation mentionnées dans cet [article](https://luislaum.github.io/blog/marbec-gpu-main-cmds/marbec-gpu-main-cmds.html) (par ex. `..` pour indiquer un dossier précédent). La syntaxe de base est : `cp chemin/source chemin/destination`, mais il existe plusieurs cas possibles :
