---
title: "First steps on `marbec-data` and `marbec-gpu`"
author: 
...
description: |
  Comment accéder à `marbec-gpu` et `marbec-data` ? | How to access to `marbec-gpu` and `marbec-data`? 
date: 2024-10-21
image: banner.jpg
about: 
  template: marquee
...
draft: false
tags: ["marbec-data", "marbec-gpu", "access", "accéder", "password", "mot de passe"]
categories: ["marbec-data", "marbec-gpu", "guides"]
---

Image credits: Tim Mossholder at [Unplash](https://unsplash.com/photos/bleu-entry-signage-WHXbCz2KWhE?utm_content=creditShareLink&utm_medium=referral&utm_source=unsplash)
...
Nous avons un [article](../marbec-data-manage-files/marbec-data-manage-files.qmd) où nous développons ce point plus en détail.
...
Nous avons un [article](../marbec-gpu-basic-example/marbec-gpu-basic-example.qmd) où nous développons ce point plus en détail.
...
We have a [post](../marbec-data-manage-files/marbec-data-manage-files.qmd) where we develop this point in more detail.
...
We have a [post](../marbec-gpu-basic-example/marbec-gpu-basic-example.qmd) where we develop this point in more detail.
