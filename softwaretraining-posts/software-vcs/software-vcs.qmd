...
description: |
  Ce qu'est un système de contrôle des versions et quelles sont les options disponibles. | What a Version Control System is and what options are available.
date: 2025-01-31
image: banner.jpg
about: 
  template: marquee
...
Image credits: Yancy Min at [Unsplash](https://unsplash.com/photos/a-close-up-of-a-text-description-on-a-computer-screen-842ofHC6MaI?utm_content=creditShareLink&utm_medium=referral&utm_source=unsplash)
...
Un rapide coup d'œil sur internet vous montrera qu'il existe plusieurs forges. L'une des plus populaires est [GitHub](https://github.com/){.external target="_blank"} mais il en existe d'autres comme [GitLab](https://gitlab.com/){.external target="_blank"} ou encore [Bitbucket](https://bitbucket.org/){.external target="_blank"}. Il est aussi tout à fait possible que votre institut ou organisme utilise l'un de ces systèmes pour héberger sa propre forge (jeter un coup d'œil [ici](../course-git/course-git.qmd){.external target="_blank"}). Chaque système présente des avantages et des inconvénients et votre choix doit être guidé par vos besoins. À titre d'exemple vous trouverez un rapide comparatif des principales forges dans le tableau ci-dessous.
...
<div style="text-align: center;">
  ![Figure 1 : Configuration du dépôt source GitHub](images/01_create_new_repository_github.png){fig-align="center" width="70%"}
</div>
...
<div style="text-align: center;">
  ![Figure 2 : Configuration du dépôt cible GitLab](images/02_create_new_repository_gitlabird.png){fig-align="center"}
</div>
...
<div style="text-align: center;">
  ![Figure 3 : Onglet "Access tokens"](images/03_access_tokens.png){fig-align="center"}
</div>
...
<div style="text-align: center;">
  ![Figure 4 : Configuration du jeton d'accés](images/04_configuration_access_tokens.png){fig-align="center"}
</div>
...
<div style="text-align: center;">
  ![Figure 5 : Configuration d'un secret associé à un dépôt GitHub](images/05_new_repository_secret.png){fig-align="center"}
</div>
...
Pour faire cela, nous avons deux possibilités, (1) créer et adapter manuellement notre fichier yaml associé à la "GitHub Action" ou (2) utiliser une fonction du package [sparck](../software-rpkg-sparck/software-rpkg-sparck.qmd){.external target="_blank"} qui va nous simplifier les étapes de création. 
...
<div style="text-align: center;">
  ![Figure 6 : Erreur en lien avec une branche protégée](images/06_error_branch_protected.png){fig-align="center"}
</div>
...
<div style="text-align: center;">
  ![Figure 7 : Page "Protected branches"](images/07_unprotected_branch.png){fig-align="center"}
</div>
...
<div style="text-align: center;">
  ![Figure 1: Setting up the GitHub source repository](images/01_create_new_repository_github.png){fig-align="center" width="70%"}
</div>
...
<div style="text-align: center;">
  ![Figure 2: Setting up the GitLab target repository](images/02_create_new_repository_gitlabird.png){fig-align="center"}
</div>
...
<div style="text-align: center;">
  ![Figure 3: Page "Access tokens"](images/03_access_tokens.png){fig-align="center"}
</div>
...
<div style="text-align: center;">
  ![Figure 4: Access token configuration](images/04_configuration_access_tokens.png){fig-align="center"}
</div>
...
<div style="text-align: center;">
  ![Figure 5: Configuring a secret associated with a GitHub repository](images/05_new_repository_secret.png){fig-align="center"}
</div>
...
To do this, we have two options: (1) manually create and adapt our yaml file associated with the “GitHub Action” or (2) use a function in the package [sparck](../software-rpkg-sparck/software-rpkg-sparck.qmd){.external target=“_blank”} which will simplify the creation process.  
...
If you prefer a simplified approach, you can use the R package [sparck](../software-rpkg-sparck/software-rpkg-sparck.qmd){.external target=“_blank”} and the associated function [add_github_action()](https://umr-marbec.github.io/sparck/reference/add_github_action.html){.external target=“_blank”}.
...
<div style="text-align: center;">
  ![Figure 6: Error related to a protected branch](images/06_error_branch_protected.png){fig-align="center"}
</div>
