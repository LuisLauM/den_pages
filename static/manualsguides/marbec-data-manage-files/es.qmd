...
Para esto, la manera más sencilla es a través del comando `cp` y haciendo uso de los comandos de navegación citados en este [post](https://luislaum.github.io/den_pages/static/manualsguides/marbec-gpu-main-cmds/en.html) (e.g. `..` para indicar una carpeta anterior). La sintaxis básica es la siguiente: `cp ruta/de/origen ruta/de/destino`, pero existen diferentes casos posibles:
