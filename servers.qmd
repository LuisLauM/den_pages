...
* 4 GPUs
* Système d'ordonnancement des tâches: PBS
...
* 1,48 To de RAM
* Système d'ordonnancement des tâches: SLURM

Sur ce site web, vous pouvez trouver des articles sur la façon d'utiliser correctement `marbec-gpu` et `marbec-data`, jetez un coup d'oeil à la section [Manuals and Guides](manualsguides.qmd).

### Meso\@LR

Site officiel : [meso-lr.umontpellier.fr](https://meso-lr.umontpellier.fr/)

L’accès aux ressources est accordé après avoir effectué une demande de ressources et avoir répondu aux modalités financières et administratives telles que mises à jour et détaillées sur le site web <https://meso-lr.umontpellier.fr>.

Features:

* CPUs: 28 coeurs, 308 noeuds de calcul , [Intel Xeon E5-2680](https://www.intel.com/content/www/us/en/products/sku/64583/intel-xeon-processor-e52680-20m-cache-2-70-ghz-8-00-gts-intel-qpi/specifications.html) @ 2,4 GHz
* GPUs: 2 noeuds, 26 coeurs (52 threads), [NVIDIA RTX 6000](https://www.nvidia.com/en-us/design-visualization/rtx-6000/)
* 3 To de RAM
* Système d'ordonnancement des tâches: SLURM

![](images/servers/mesolr-1.jpg)
...
Official web site: [meso-lr.umontpellier.fr](https://meso-lr.umontpellier.fr/)

Way to access: Access to resources is granted after submitting a resource request and meeting the financial and administrative as updated and detailed on the <https://meso-lr.umontpellier.fr> website.

Features:

* CPUs: 28 cores, 308 nodes, [Intel Xeon E5-2680](https://www.intel.com/content/www/us/en/products/sku/64583/intel-xeon-processor-e52680-20m-cache-2-70-ghz-8-00-gts-intel-qpi/specifications.html) @ 2,4 GHz
* GPUs: 2 nodes with 26 cores (52 threads), [NVIDIA RTX 6000](https://www.nvidia.com/en-us/design-visualization/rtx-6000/)
* 3 TB of RAM
* Job scheduler system: SLURM
